...
const GiveawayItem = ({ data, index, children }) => {
    return (
            <ListItem avatar>
              <Left>
                <Thumbnail source={{ uri: 'http://www.100cal.co.il/CreateTumbImage.aspx?width=428&height=300&path=/Portals/0/ProductImages/br-m98313-s00000-a-Taubread-s-WS.JPG' }} />
              </Left>
              <Body>
